...
/*
    숫자 타입으로 형변환
    - + 연산자를 제외한 나머지 산술 연산 혹은 대소 비교 연산에 대해서 좌항과? 연산에 대해서 좌항과 우항 중 하나라도 숫자가 존재하면 숫자가 아닌 항을 숫자로 자동 형 변환
*/
console.log(1 - '1');
...
/*
    불리언 타입으로 형변환
    - '', 0, -0, NaN, null undefined,는 false, 나머지는 true로 자동 형 변환
*/
...
/*
    ...
    - 문자열 경우 parseInt(문자열), parseFloat(문자열) 메서드 사용 가능
*/
